//====================================================================
//
// File:      $RCSfile: AbstractModelElementFileEditorInput.java,v $
 ...
 */
public abstract class AbstractModelElementFileEditorInput extends AbstractModelElementEditorInput implements
		IFileEditorInput, IPathEditorInput {

	protected IFile storage = null;
	...
	/*
	 * Constructor for creating an instance of AbstractModelElementFileEditorInput
	 ...
	 * is left for Factory.
	 */
	protected AbstractModelElementFileEditorInput(ModelElementID aModelElementID, IFile placeHolderFile)
	 ...
	 * storage.
	 */
	protected abstract IFile createStorage();
	...
	public void doSaveDocument(IProgressMonitor monitor, Object element, IDocument document, boolean overwrite) {
		//IDocumentProvider
                IFile storage = (IFile) getStorage();
		try {
			byte[] contents = null;
			try {
				contents = document.get().getBytes("UTF-8");
			} catch ( UnsupportedEncodingException e ) {
				System.out.println( e );
			}
			storage.setContents(new ByteArrayInputStream(contents), true, false, null);
	...
	public boolean equals(Object input) {
	    if (input instanceof AbstractModelElementFileEditorInput){
